...
public class ConstraintSolver {
    ...
    public ConstraintSolver(List<Vector3> positions, List<Quaternion> orientations, Map<RigidBody, Integer> mapBodyToVelocityIndex) {
        ...
        mConstraintSolverData = new @Dimensionless ConstraintSolverData(positions, orientations, mapBodyToVelocityIndex);
    ...
    public void setIsNonLinearGaussSeidelPositionCorrectionActive(@Dimensionless ConstraintSolver this, boolean isActive) {
        throw new @Dimensionless UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    // Initialize the constraint solver for a given island
    public void initializeForIsland(@Dimensionless ConstraintSolver this, float dt, Island island) {
        ...
        assert (island.getNumJoints() > ((@Dimensionless int) (0)));
        ...
        @Dimensionless
        Joint @Dimensionless [] joints = island.getJoints();
        for (@Dimensionless int i = ((@Dimensionless int) (0)); i < island.getNumJoints(); i++) {
    ...
    public void setConstrainedVelocitiesArrays(@Dimensionless ConstraintSolver this, Vector3[] constrainedLinearVelocities, Vector3[] constrainedAngularVelocities) {
    ...
    public void solvePositionConstraints(@Dimensionless ConstraintSolver this, Island island) {
    ...
    public void solveVelocityConstraints(@Dimensionless ConstraintSolver this, Island island) {
