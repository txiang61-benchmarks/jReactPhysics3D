...
public abstract class EventListener {
    ...
    public abstract void beginContact(@Dimensionless EventListener this, @Dimensionless ContactPointInfo contact);

    // Called when a new contact point is found between two bodies
    public abstract void newContact(@Dimensionless EventListener this, @Dimensionless ContactPointInfo contact);
