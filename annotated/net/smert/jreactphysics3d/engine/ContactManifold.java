...
public class ContactManifold {
    ...
    public final static @Dimensionless int MAX_CONTACT_POINTS_IN_MANIFOLD = ((@Dimensionless int) (4));

    // True if the contact manifold has already been added into an island
    private @Dimensionless boolean isAlreadyInIsland;
    ...
    private @Dimensionless int numContactPoints;
    ...
    private final @Dimensionless ContactPoint @Dimensionless [] contactPoints = new @Dimensionless ContactPoint @Dimensionless [MAX_CONTACT_POINTS_IN_MANIFOLD];
    ...
    public ContactManifold(@Dimensionless CollisionBody body1, @Dimensionless CollisionBody body2) {
        ...
        frictionImpulse1 = ((@Dimensionless float) (0.0f));
        frictionImpulse2 = ((@Dimensionless float) (0.0f));
        frictionTwistImpulse = ((@Dimensionless float) (0.0f));
        numContactPoints = ((@Dimensionless int) (0));
        this.body1 = body1;
        this.body2 = body2;
    }
    ...
    private @Dimensionless int getIndexOfDeepestPenetration(@Dimensionless ContactManifold this, @Dimensionless ContactPoint newContact) {
        ...
        for (@Dimensionless int i = ((@Dimensionless int) (0)); i < numContactPoints; i++) {
    ...
    private @Dimensionless int getIndexToRemove(@Dimensionless ContactManifold this, @Dimensionless int indexMaxPenetration, @Dimensionless Vector3 newPoint) {
        ...
        @Dimensionless
        float area0 = ((@Dimensionless float) (0.0f));       // Area with contact 1,2,3 and newPoint
        @Dimensionless
        float area1 = ((@Dimensionless float) (0.0f));       // Area with contact 0,2,3 and newPoint
        @Dimensionless
        float area2 = ((@Dimensionless float) (0.0f));       // Area with contact 0,1,3 and newPoint
        @Dimensionless
        float area3 = ((@Dimensionless float) (0.0f));       // Area with contact 0,1,2 and newPoint

        if (indexMaxPenetration != ((@Dimensionless int) (0))) {
            // Compute the area
            @Dimensionless
            Vector3 vector1 = new @Dimensionless Vector3(newPoint).subtract(contactPoints[((@Dimensionless int) (1))].getLocalPointOnBody1());
            @Dimensionless
            Vector3 vector2 = new @Dimensionless Vector3(contactPoints[((@Dimensionless int) (3))].getLocalPointOnBody1()).subtract(contactPoints[((@Dimensionless int) (2))].getLocalPointOnBody1());
            @Dimensionless
            Vector3 crossProduct = new @Dimensionless Vector3(vector1).cross(vector2);
            area0 = crossProduct.lengthSquare();
        }
        if (indexMaxPenetration != ((@Dimensionless int) (1))) {
            // Compute the area
            @Dimensionless
            Vector3 vector1 = new @Dimensionless Vector3(newPoint).subtract(contactPoints[((@Dimensionless int) (0))].getLocalPointOnBody1());
            @Dimensionless
            Vector3 vector2 = new @Dimensionless Vector3(contactPoints[((@Dimensionless int) (3))].getLocalPointOnBody1()).subtract(contactPoints[((@Dimensionless int) (2))].getLocalPointOnBody1());
            @Dimensionless
            Vector3 crossProduct = new @Dimensionless Vector3(vector1).cross(vector2);
        ...
        if (indexMaxPenetration != ((@Dimensionless int) (2))) {
            ...
            Vector3 vector1 = new @Dimensionless Vector3(newPoint).subtract(contactPoints[((@Dimensionless int) (0))].getLocalPointOnBody1());
            @Dimensionless
            Vector3 vector2 = new @Dimensionless Vector3(contactPoints[((@Dimensionless int) (3))].getLocalPointOnBody1()).subtract(contactPoints[((@Dimensionless int) (1))].getLocalPointOnBody1());
            @Dimensionless
            Vector3 crossProduct = new @Dimensionless Vector3(vector1).cross(vector2);
        ...
        if (indexMaxPenetration != ((@Dimensionless int) (3))) {
            ...
            Vector3 vector1 = new @Dimensionless Vector3(newPoint).subtract(contactPoints[((@Dimensionless int) (0))].getLocalPointOnBody1());
            @Dimensionless
            Vector3 vector2 = new @Dimensionless Vector3(contactPoints[((@Dimensionless int) (2))].getLocalPointOnBody1()).subtract(contactPoints[((@Dimensionless int) (1))].getLocalPointOnBody1());
            @Dimensionless
            Vector3 crossProduct = new @Dimensionless Vector3(vector1).cross(vector2);
    ...
    private @Dimensionless int getMaxArea(@Dimensionless ContactManifold this, @Dimensionless float area0, @Dimensionless float area1, @Dimensionless float area2, @Dimensionless float area3) {
        if (area0 < area1) {
            if (area1 < area2) {
                if (area2 < area3) {
    ...
    private void removeContactPoint(@Dimensionless ContactManifold this, @Dimensionless int index) {
        ...
        assert (numContactPoints > ((@Dimensionless int) (0)));

        // Call the destructor explicitly and tell the memory allocator that
        // the corresponding memory block is now free
        // If we don't remove the last index
        if (index < numContactPoints - ((@Dimensionless int) (1))) {
            contactPoints[index] = contactPoints[numContactPoints - ((@Dimensionless int) (1))];
        }
    ...
    public void addContactPoint(@Dimensionless ContactManifold this, @Dimensionless ContactPoint contact) {
        ...
        for (@Dimensionless int i = ((@Dimensionless int) (0)); i < numContactPoints; i++) {
            ...
            @Dimensionless
            float distance = new @Dimensionless Vector3(contactPoints[i].getWorldPointOnBody1()).subtract(contact.getWorldPointOnBody1()).lengthSquare();
    ...
    public @Dimensionless float getFrictionImpulse1(@Dimensionless ContactManifold this) {
        return frictionImpulse1;
    }

    // Set the first friction accumulated impulse
    public void setFrictionImpulse1(@Dimensionless ContactManifold this, @Dimensionless float frictionImpulse1) {
        this.frictionImpulse1 = frictionImpulse1;
    }

    // Return the second friction accumulated impulse
    public @Dimensionless float getFrictionImpulse2(@Dimensionless ContactManifold this) {
        return frictionImpulse2;
    }

    // Set the second friction accumulated impulse
    public void setFrictionImpulse2(@Dimensionless ContactManifold this, @Dimensionless float frictionImpulse2) {
    ...
    public @Dimensionless int getNumContactPoints(@Dimensionless ContactManifold this) {
        return numContactPoints;
    }

    // Return a pointer to the first body of the contact manifold
    public @Dimensionless CollisionBody getBody1(@Dimensionless ContactManifold this) {
        return body1;
    }

    // Return a pointer to the second body of the contact manifold
    public @Dimensionless CollisionBody getBody2(@Dimensionless ContactManifold this) {
        return body2;
    }

    // Return a contact point of the manifold
    public @Dimensionless ContactPoint getContactPoint(@Dimensionless ContactManifold this, @Dimensionless int index) {
        assert (index >= ((@Dimensionless int) (0)) && index < numContactPoints);
        return contactPoints[index];
    }

    // Return the first friction vector at the center of the contact manifold
    public @Dimensionless Vector3 getFrictionVector1(@Dimensionless ContactManifold this) {
        return frictionVector1;
    }

    // set the first friction vector at the center of the contact manifold
    public void setFrictionVector1(@Dimensionless ContactManifold this, @Dimensionless Vector3 frictionVector1) {
        this.frictionVector1.set(frictionVector1);
    }

    // Return the second friction vector at the center of the contact manifold
    public @Dimensionless Vector3 getFrictionVector2(@Dimensionless ContactManifold this) {
        return frictionVector2;
    }

    // set the second friction vector at the center of the contact manifold
    public void setFrictionVector2(@Dimensionless ContactManifold this, @Dimensionless Vector3 frictionVector2) {
    ...
    public void update(@Dimensionless ContactManifold this, @Dimensionless Transform transform1, @Dimensionless Transform transform2) {
        ...
        if (numContactPoints == ((@Dimensionless int) (0))) {
            return;
        }

        // Update the world coordinates and penetration depth of the contact points in the manifold
        for (@Dimensionless int i = ((@Dimensionless int) (0)); i < numContactPoints; i++) {
            contactPoints[i].setWorldPointOnBody1(transform1.multiply(contactPoints[i].getLocalPointOnBody1(), new @Dimensionless Vector3()));
            contactPoints[i].setWorldPointOnBody2(transform2.multiply(contactPoints[i].getLocalPointOnBody2(), new @Dimensionless Vector3()));
            contactPoints[i].setPenetrationDepth(new @Dimensionless Vector3(contactPoints[i].getWorldPointOnBody1()).subtract(
        ...
        for (@Dimensionless int i = (@Dimensionless int) (numContactPoints) - ((@Dimensionless int) (1)); i >= ((@Dimensionless int) (0)); i--) {
            assert (i < (@Dimensionless int) (numContactPoints));
            ...
            if (distanceNormal > squarePersistentContactThreshold) {
                ...
                @Dimensionless
                Vector3 projOfPoint1 = new @Dimensionless Vector3(contactPoints[i].getWorldPointOnBody1()).add(
                        new @Dimensionless Vector3(contactPoints[i].getNormal()).multiply(distanceNormal));
                @Dimensionless
                Vector3 projDifference = new @Dimensionless Vector3(contactPoints[i].getWorldPointOnBody2()).subtract(projOfPoint1);
