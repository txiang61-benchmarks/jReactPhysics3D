...
public class CollisionWorld {
    ...
    // Current body ID
    protected @Dimensionless int currentBodyID;

    // Reference to the collision detection
    protected @Dimensionless CollisionDetection collisionDetection;

    // All the collision shapes of the world
    protected @Dimensionless List<@Dimensionless CollisionShape> collisionShapes;

    // List of free ID for rigid bodies
    protected @Dimensionless List<@Dimensionless Integer> freeBodiesIDs;

    // Broad-phase overlapping pairs of bodies
    protected @Dimensionless Map<@Dimensionless BodyIndexPair, @Dimensionless OverlappingPair> overlappingPairs;

    // All the bodies (rigid and soft) of the world
    protected @Dimensionless Set<@Dimensionless CollisionBody> bodies;

    // Constructor
    public CollisionWorld() {
        currentBodyID = ((@Dimensionless int) (0));
        collisionDetection = new @Dimensionless CollisionDetection(this);
        collisionShapes = new @Dimensionless ArrayList<>();
        freeBodiesIDs = new @Dimensionless ArrayList<>();
        overlappingPairs = new @Dimensionless HashMap<>();
        bodies = new @Dimensionless HashSet<>();
    }
    ...
    protected @Dimensionless CollisionShape createCollisionShape(@Dimensionless CollisionWorld this, @Dimensionless CollisionShape collisionShape) {
        ...
        for (@Dimensionless CollisionShape it : collisionShapes) {
    ...
    protected @Dimensionless int computeNextAvailableBodyID(@Dimensionless CollisionWorld this) {
        ...
        if (!freeBodiesIDs.isEmpty()) {
            @Dimensionless
            int lastIndex = freeBodiesIDs.size() - ((@Dimensionless int) (1));
    ...
    protected void removeCollisionShape(@Dimensionless CollisionWorld this, @Dimensionless CollisionShape collisionShape) {
        ...
        assert (collisionShape.getNumSimilarCreatedShapes() != ((@Dimensionless int) (0)));
        ...
        if (collisionShape.getNumSimilarCreatedShapes() == ((@Dimensionless int) (0))) {
    ...
    public @Dimensionless CollisionBody createCollisionBody(@Dimensionless CollisionWorld this, @Dimensionless Transform transform, @Dimensionless CollisionShape collisionShape) {
        ...
        @Dimensionless
        CollisionBody collisionBody = new @Dimensionless CollisionBody(transform, collisionShape, bodyID);
    ...
    public void destroyCollisionBody(@Dimensionless CollisionWorld this, @Dimensionless CollisionBody collisionBody) {
    ...
    public void notifyAddedOverlappingPair(@Dimensionless CollisionWorld this, BroadPhasePair addedPair) {
    }

    // Notify the world about a new narrow-phase contact
    public void notifyNewContact(@Dimensionless CollisionWorld this, BroadPhasePair broadPhasePair, ContactPointInfo contactInfo) {
    }

    // Notify the world about a removed broad-phase overlapping pair
    public void notifyRemovedOverlappingPair(@Dimensionless CollisionWorld this, BroadPhasePair removedPair) {
    }

    // Update the overlapping pair
    public void updateOverlappingPair(@Dimensionless CollisionWorld this, BroadPhasePair pair) {
    }
