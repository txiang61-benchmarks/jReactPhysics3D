...
public class Island {
    ...
    private @Dimensionless int numBodies;
    ...
    private @Dimensionless int numJoints;

    // Array with all the contact manifolds between bodies of the island
    private final @Dimensionless ContactManifold @Dimensionless [] contactManifolds;

    // Array with all the joints between bodies of the island
    private final @Dimensionless Joint @Dimensionless [] joints;

    // Array with all the bodies of the island
    private final @Dimensionless RigidBody @Dimensionless [] bodies;

    // Constructor
    public Island(@Dimensionless int numMaxBodies, @Dimensionless int numMaxContactManifolds, @Dimensionless int numMaxJoints) {
        numBodies = ((@Dimensionless int) (0));
        numContactManifolds = ((@Dimensionless int) (0));
        numJoints = ((@Dimensionless int) (0));
        bodies = new @Dimensionless RigidBody @Dimensionless [numMaxBodies];
        contactManifolds = new @Dimensionless ContactManifold @Dimensionless [numMaxContactManifolds];
        joints = new @Dimensionless Joint @Dimensionless [numMaxJoints];
    }
    ...
    public @Dimensionless int getNumBodies(@Dimensionless Island this) {
        return numBodies;
    }

    // Return the number of contact manifolds in the island
    public @Dimensionless int getNumContactManifolds(@Dimensionless Island this) {
        return numContactManifolds;
    }

    // Return the number of joints in the island
    public @Dimensionless int getNumJoints(@Dimensionless Island this) {
        return numJoints;
    }
    ...
    public @Dimensionless Joint @Dimensionless [] getJoints(@Dimensionless Island this) {
        return joints;
    }
