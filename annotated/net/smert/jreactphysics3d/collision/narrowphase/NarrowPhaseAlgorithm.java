...
public abstract class NarrowPhaseAlgorithm {
    ...
    protected @Dimensionless BroadPhasePair currentOverlappingPair;
    ...
    public void setCurrentOverlappingPair(@Dimensionless NarrowPhaseAlgorithm this, @Dimensionless BroadPhasePair overlappingPair) {
        currentOverlappingPair = overlappingPair;
    }

    // Return true and compute a contact info if the two bounding volume collide
    public abstract @Dimensionless boolean testCollision(
            @Dimensionless NarrowPhaseAlgorithm this, @Dimensionless
