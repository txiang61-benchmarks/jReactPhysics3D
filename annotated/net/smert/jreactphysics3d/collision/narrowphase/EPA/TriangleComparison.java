...
public class TriangleComparison implements Comparator<TriangleEPA> {
    ...
    @Override
    public @Dimensionless int compare(@Dimensionless TriangleComparison this, @Dimensionless TriangleEPA face1, @Dimensionless TriangleEPA face2) {
        if (face1.getDistanceSquare() == face2.getDistanceSquare()) {
            return ((@Dimensionless int) (0));
        }
        return face1.getDistanceSquare() > face2.getDistanceSquare() ? ((@Dimensionless int) (1)) : ((@Dimensionless int) (-1));
    }
