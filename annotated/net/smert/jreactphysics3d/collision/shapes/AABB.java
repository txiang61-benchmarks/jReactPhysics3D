...
public class AABB {
    ...
    private final @Dimensionless Vector3 mMaxCoordinates;

    // Minimum world coordinates of the AABB on the x,y and z axis
    private final @Dimensionless Vector3 mMinCoordinates;

    // Constructor
    public AABB() {
        mMaxCoordinates = new @Dimensionless Vector3();
        mMinCoordinates = new @Dimensionless Vector3();
    }
    ...
    public @Dimensionless Vector3 getCenter(@Dimensionless AABB this) {
        return new @Dimensionless Vector3(mMinCoordinates).add(mMaxCoordinates).multiply(((@Dimensionless float) (0.5f)));
    }
