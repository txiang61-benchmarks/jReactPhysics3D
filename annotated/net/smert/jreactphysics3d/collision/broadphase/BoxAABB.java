...
public class BoxAABB {
    ...
    public final int[] min = new @Dimensionless int @Dimensionless [((@Dimensionless int) (3))];

    // Index of the 3 maximum end-points of the AABB over the x,y,z axis
    public final int[] max = new @Dimensionless int @Dimensionless [((@Dimensionless int) (3))];
