...
public class SliderJointInfo extends JointInfo {
    ...
    // Constructor
    public SliderJointInfo(@Dimensionless JointType constraintType) {
        super(constraintType);
    }

    // Constructor without limits and without motor
    public SliderJointInfo(@Dimensionless RigidBody rigidBody1, @Dimensionless RigidBody rigidBody2,
            @Dimensionless
            Vector3 initAnchorPointWorldSpace, @Dimensionless Vector3 initSliderAxisWorldSpace) {
        super(rigidBody1, rigidBody2, JointType.SLIDERJOINT);
        anchorPointWorldSpace = initAnchorPointWorldSpace;
        sliderAxisWorldSpace = initSliderAxisWorldSpace;
        isLimitEnabled = false;
        isMotorEnabled = false;
        minTranslationLimit = - ((@Dimensionless float) (1.0f));
        maxTranslationLimit = ((@Dimensionless float) (1.0f));
        motorSpeed = ((@Dimensionless float) (0.0f));
        maxMotorForce = ((@Dimensionless float) (0.0f));
    }
    ...
    public SliderJointInfo(@Dimensionless RigidBody rigidBody1, @Dimensionless RigidBody rigidBody2,
            ...
            Vector3 initAnchorPointWorldSpace, @Dimensionless Vector3 initSliderAxisWorldSpace,
            @Dimensionless
            float initMinTranslationLimit, @Dimensionless float initMaxTranslationLimit) {
        super(rigidBody1, rigidBody2, JointType.SLIDERJOINT);
        anchorPointWorldSpace = initAnchorPointWorldSpace;
        sliderAxisWorldSpace = initSliderAxisWorldSpace;
        isLimitEnabled = true;
    ...
    public SliderJointInfo(@Dimensionless RigidBody rigidBody1, @Dimensionless RigidBody rigidBody2,
            ...
            float initMinTranslationLimit, @Dimensionless float initMaxTranslationLimit,
            @Dimensionless
            float initMotorSpeed, @Dimensionless float initMaxMotorForce) {
        super(rigidBody1, rigidBody2, JointType.SLIDERJOINT);
        anchorPointWorldSpace = initAnchorPointWorldSpace;
        sliderAxisWorldSpace = initSliderAxisWorldSpace;
        isLimitEnabled = true;
