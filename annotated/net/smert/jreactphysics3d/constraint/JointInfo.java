...
public class JointInfo {
    ...
    // Constructor
    public JointInfo(@Dimensionless JointType constraintType) {
        body1 = null;
        body2 = null;
        type = constraintType;
    ...
    // Constructor
    public JointInfo(@Dimensionless RigidBody rigidBody1, @Dimensionless RigidBody rigidBody2, @Dimensionless JointType constraintType) {
        body1 = rigidBody1;
        body2 = rigidBody2;
        type = constraintType;
        positionCorrectionTechnique = JointsPositionCorrectionTechnique.NON_LINEAR_GAUSS_SEIDEL;
