...
public class BallAndSocketJointInfo extends JointInfo {
    ...
    public @Dimensionless Vector3 anchorPointWorldSpace;

    // Constructor
    public BallAndSocketJointInfo(@Dimensionless JointType constraintType) {
        super(constraintType);
    }

    // Constructor
    public BallAndSocketJointInfo(@Dimensionless RigidBody rigidBody1, @Dimensionless RigidBody rigidBody2, @Dimensionless Vector3 initAnchorPointWorldSpace) {
