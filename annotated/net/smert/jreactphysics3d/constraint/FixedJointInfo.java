...
public class FixedJointInfo extends JointInfo {
    ...
    // Constructor
    public FixedJointInfo(@Dimensionless JointType constraintType) {
        super(constraintType);
    }

    // Constructor
    public FixedJointInfo(@Dimensionless RigidBody rigidBody1, @Dimensionless RigidBody rigidBody2, @Dimensionless Vector3 initAnchorPointWorldSpace) {
